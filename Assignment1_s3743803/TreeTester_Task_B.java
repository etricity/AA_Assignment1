...
public class TreeTester_Task_B {

    private static final String SEQUENTIAL_TREE = "seqtree";
    private static final String LINKED_TREE = "linktree";
    private static final String SAMPLE = "sample";

    private static TimeTester  tt = new TimeTester();
    private static PrintWriter outputCommands;
    private static StringBuilder sb = new StringBuilder();
    private static String commandsToOutput = "";

    /**
     * Print help/usage message.
     */
    private static void usage() {
        String progName = TreeTester_Task_B.class.getSimpleName();
    ...
    public static void processOperations(
        ...
        while (!bQuit && (line = inReader.readLine()) != null) {
            ...
            sb.append(tokens[0].toUpperCase());
            ...
            try {
                ...
                switch (command.toUpperCase()) {
                    ...
                    // split node
                    case "SP":
                        //Might need to change to allow for multiple SP commands to occur in time testing
    ...
    public static void main(String[] args) {
        ...
        if (inputFilename != null) {
            try (BufferedReader reader = new BufferedReader(new FileReader(inputFilename))) {
                ...
                int num = 0;
                //Loading the tree time has some addiitional time due to lines 259-272
                tt.start();
        ...
        //Initilses the outPutCommands writer
        try {
            outputCommands = new PrintWriter("tree.in");
        ...
        try (BufferedReader inReader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            writer.close();
            outputCommands.print(sb.toString());
